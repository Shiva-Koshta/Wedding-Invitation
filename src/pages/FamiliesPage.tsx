...
export default function FamiliesPage() {
  return (
    <PageShell>
      ...
      <div className="relative mb-6 w-full max-w-sm overflow-hidden rounded-2xl border-2 border-gold/50 shadow-lg">
        <img src={IMAGES.familiesUnion} alt="Two families coming together" className="w-full object-cover" />
      </div>
      <p className="max-w-md font-serif text-lg leading-relaxed text-maroon/90 sm:text-xl">
